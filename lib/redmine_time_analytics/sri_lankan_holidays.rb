...
module RedmineTimeAnalytics
  class SriLankanHolidays
    ...
    POYA_DAYS_2024 = [
      ...
      Date.new(2024, 2, 24),  # Navam Poya
      Date.new(2024, 3, 25),  # Medin Poya
      Date.new(2024, 4, 23),  # Bak Poya
      Date.new(2024, 5, 23),  # Vesak Poya
      Date.new(2024, 6, 21),  # Poson Poya
      Date.new(2024, 7, 21),  # Esala Poya
      Date.new(2024, 8, 19),  # Nikini Poya
      Date.new(2024, 9, 18),  # Binara Poya
    ...
    POYA_DAYS_2025 = [
      ...
      Date.new(2025, 3, 14),  # Medin Poya
      Date.new(2025, 4, 13),  # Bak Poya
      Date.new(2025, 5, 12),  # Vesak Poya
      Date.new(2025, 6, 11),  # Poson Poya
      Date.new(2025, 7, 10),  # Esala Poya
      Date.new(2025, 8, 9),   # Nikini Poya
    ...
    POYA_DAYS_2026 = [
      Date.new(2026, 1, 2),   # Duruthu Poya
      Date.new(2026, 1, 31),  # Navam Poya
      Date.new(2026, 3, 3),   # Medin Poya
      ...
      Date.new(2026, 7, 28),  # Nikini Poya
      Date.new(2026, 8, 27),  # Binara Poya
      Date.new(2026, 9, 25),  # Vap Poya
      Date.new(2026, 10, 25), # Il Poya
      Date.new(2026, 11, 23), # Unduvap Poya
    ...
    ISLAMIC_HOLIDAYS_2024 = [
      Date.new(2024, 4, 11),  # Eid al-Fitr (Ramadan Festival)
      Date.new(2024, 6, 17),  # Eid al-Adha (Hajj Festival)
      Date.new(2024, 9, 16)   # Milad-un-Nabi (Prophet's Birthday)
    ].freeze

    ISLAMIC_HOLIDAYS_2025 = [
      Date.new(2025, 3, 31),  # Eid al-Fitr (Ramadan Festival)
      Date.new(2025, 6, 7),   # Eid al-Adha (Hajj Festival)
      Date.new(2025, 9, 5)    # Milad-un-Nabi (Prophet's Birthday)
    ].freeze

    ISLAMIC_HOLIDAYS_2026 = [
      Date.new(2026, 3, 20),  # Eid al-Fitr (Ramadan Festival)
      Date.new(2026, 5, 27),  # Eid al-Adha (Hajj Festival)
